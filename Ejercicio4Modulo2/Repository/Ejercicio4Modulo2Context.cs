...
namespace Ejercicio4Modulo2.Repository
{
    public partial class Ejercicio4Modulo2Context : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=localhost;Initial Catalog=Ejercicio4Modulo2;Persist Security Info=True;User ID=sa;Password=Password01;Trust Server Certificate=True");
        }
